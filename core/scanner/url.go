...
func NewURLScanner(config *Config) *URLScanner {
	var client = &URLScanner{
...
func (c *URLScanner) Push(URL *url.URL, response *gonmap.Response, req *http.Request, client *http.Client) {
